  ...
  return (
    <div className='thirdsection' style={{ display: 'flex', alignitems: 'center', flexDirection: 'column' }}>
      <h2 data-aos="zoom-out-up" style={{ alignSelf: 'center', width: 'fit-content', padding: '15px', marginTop: '0', background:' rgb(213 210 229 / 78%)' }}>Some of my work 💻</h2>
        ...
        <div className='project more' data-aos="fade-up">
        <a href="https://github.com/wowimnick" target='blank_' style={{position:'absolute', width:'100%', height:'100%'}}></a>
        ...
        <span style={{ fontFamily: 'Damion', textAlign: 'center', fontSize: '24px' }}>See more on Github</span>
        </div>
