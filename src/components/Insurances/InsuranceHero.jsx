...
const HERO_IMAGE =
  'https://images.unsplash.com/photo-1556742212-5b321f3c261b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80';
...
const InsuranceHero = () => {
  return (
    <HeroWrapper>
      <HeroInner>
        <TextCol>
          <Eyebrow {...fadeUpProps(0, { inView: false })}>Coverage</Eyebrow>
          <Title {...fadeUpProps(0.1, { inView: false })}>Insurance Coverage</Title>
